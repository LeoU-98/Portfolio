...
function Hero() {
  return (
    <div>
      <div className="container mx-auto flex flex-col items-center gap-10 py-12 text-white sm:flex-row lg:justify-between lg:gap-20">
        <div className="">
        ...
        <div className="grid max-w-80 grid-cols-[auto_auto_auto] gap-4">
          <div className="col-start-2 h-80 w-64 overflow-hidden rounded-xl">
